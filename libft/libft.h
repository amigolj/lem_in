...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/26 15:37:00 by mkurchin          #+#    #+#             */
/*   Updated: 2016/12/02 16:36:15 by mkurchin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_lstpush(t_list *head, void *content, size_t content_size);
int				ft_lstcount_print(t_list *lst);
